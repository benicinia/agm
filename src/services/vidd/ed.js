  ...
  setupClipContextMenu() {
    document.addEventListener('contextmenu', (e) => {
        ...
        if (clipElement) {
            ...
            // Add style picker for text clips
            if (clip.type === 'text') {
                menuItems += `
            ...
            const items = menu.querySelectorAll('.context-menu-item:not(.title-style-picker)');
...
updatePreview() {
    ...
    // Clear overlay for images and text
    ...
    if (activeVideoClip) {
        ...
        // REMOVED: The else block that was seeking the video
        // This was causing the stuttering
 ...
 // Show text in overlay with styles
if (activeTextClip) {
