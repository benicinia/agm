...
function generateActionResponseHTML(text, service, currentStep, nextStep, language) {
  const stepResponses = {
    iftms: {
...
function handleActionButton(message) {
...
function generateContinuationHTML(stepR, currentStep, language) {
  return `
    <div class="chat-messages">
      <div class="message sender">
        <div class="message-content">
          <p>🔄 ${language === 'am' ? 'ከደረጃ ቀጠል እያደረግን' : 'Continuing from step'} ${currentStep}...</p>
          <p>${stepR.text}</p>
...
// Extract intents - YOUR FUCKING ORIGINAL LOGIC
